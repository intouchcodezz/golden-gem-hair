...
const Dashboard: React.FC<DashboardProps> = ({ onLogout }) => {
  ...
  const fetchAppointments = async () => {
    try {
      const res = await fetch('https://thegoldengemhairclinic.com/backend/getAppointments.php');
  ...
  const fetchChatLogs = async () => {
    try {
      const res = await fetch('https://thegoldengemhairclinic.com/backend/getChatLogs.php');
      const data = await res.json();
